...
(function main(){
	app.system('python "C:/Users/betoe/Desktop/CAMARA LONDRINA/PhotoshopPortable/SCRIPT/Projetos de Lei das Reunioes.py" ');
	//alert("nada");
...
function processLesson(lesson){
	...
	doc.layerSets.getByName('REUNIAO').visible = false; 
